...
class ListingWidget extends Widget
{
    ...
    public function run()
    {
        ...
        $query->addSelect('ad_product.start_date, ad_product.created_at, ad_product.updated_at, ad_product.category_id, ad_product.type, ad_images.file_name, ad_images.folder');
