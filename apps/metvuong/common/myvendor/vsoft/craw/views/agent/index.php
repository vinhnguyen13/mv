        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    return $model->type == 1 ? 'Công ty' : 'Cá nhân';
                },
                'filter' => Html::activeDropDownList($searchModel, 'type', $type,['class'=>'form-control','prompt' => 'Tất cả']),
            ],
            'email',
            'website:url',
            [
                ...
                'filter' => Html::activeDropDownList($searchModel, 'source', $source,['class'=>'form-control','prompt' => 'Tất cả']),
            ],
            // 'updated_at',
