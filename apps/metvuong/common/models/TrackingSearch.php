...
class TrackingSearch extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'type', 'city_id', 'district_id', 'ward_id', 'street_id', 'project_building_id', 'room_no', 'toilet_no', 'price_min', 'price_max', 'size_min', 'size_max', 'is_mobile', 'from', 'created_at'], 'integer'],
            [['session', 'category_id', 'order_by'], 'string', 'max' => 32],
            [['ip', 'alias', 'location', 'agent'], 'string', 'max' => 255],
            [['referer'], 'string', 'max' => 512],
        ];
    }
