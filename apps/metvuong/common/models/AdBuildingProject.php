...
class AdBuildingProject extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['city_id', 'district_id', 'lift', 'start_date', 'created_at', 'updated_at', 'status'], 'integer'],
            [['name', 'slug', 'created_at'], 'required'],
            [['description', 'location_detail', 'facilities_detail', 'seo_title', 'seo_keywords', 'seo_description', 'gallery', 'video', 'progress'], 'string'],
            [['facade_width', 'lng', 'lat'], 'number'],
            [['name'], 'string', 'max' => 100],
            [['logo', 'location', 'investment_type', 'commercial_leasing_area', 'owner_type', 'facilities', 'website', 'slug'], 'string', 'max' => 255],
    ...
    {
        return $this->hasMany(AdArchitectBuildingProject::className(), ['building_project_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(AdContractorBuildingProject::className(), ['building_project_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(AdFacilityBuildingProject::className(), ['building_project_id' => 'id']);
    }
