...
$content = str_replace(PHP_EOL, "<br>", $contact['content']);
$content = str_replace($contact['address'], "<a href=''>".$contact['address']."</a>", $content);
?>
...
<p style="font-size: 13px;margin-bottom: 35px;line-height:20px">
    Có một người đã muốn chia sẽ tin đăng bất động sản trên <a href="<?=\yii\helpers\Url::home(true)?>" style="text-decoration: none;">Metvuong.com</a> với bạn, họ đã kèm theo một tin nhắn
</p>

<p style="padding-left: 40px;font-size: 13px;margin-bottom: 35px;line-height:20px"><?= $content?></p>
