...
<header class="clearfix header">
    ...
    <div id="settings-user" class="settings-user">
        ...
        <ul class="clearfix">
            ...
            <li><a data-method="post" href="<?=Url::to(['member/update-profile', 'username'=>Yii::$app->user->identity->username])?>"><div><span class="icon icon-per"></span></div>TÀI KHOẢN CỦA BẠN</a></li>
