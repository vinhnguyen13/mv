			...
			<div class="search-subpage clearfix">
				<form id="" action="">
					<div class="search-fill">
						...
						<a href="#" class="advande-search-btn"><span class="bd-left"></span><span class="bd-right"></span></a>
					</div>
					<div class="advande-search">
						<div class="each-advande">
							...
							<div class="item-advande row">
								<div class="col-xs-5">
									<input type="text" class="form-control" id="" placeholder="Thấp nhất">
								</div>
								<div class="col-xs-2">
									đến
								</div>
								<div class="col-xs-5">
									<input type="text" class="form-control" id="" placeholder="Cao nhất">
								</div>
							</div>
						</div>
						<div class="each-advande">
			...
			<div class="post-listing">
				...
				<form action="">
					<ul class="clearfix step-check">
						<li>
							<a href="#">
								<span class="checkbox-ui icon"><input name="banchothue" type="radio"></span>
								<span>Bán</span>
							</a>
						</li>
						<li>
						...
						<li>
							<a href="#">
								<span class="checkbox-ui icon"><input name="agent" type="radio"></span>
								<span>Chủ nhà</span>
					...
					<div class="step-link">
						<ul class="clearfix">
							<li><a class="active" href="#">1</a><span class="icon"></span></li>
							<li><a href="#">2</a><span class="icon"></span></li>
							<li><a href="#">3</a><span class="icon"></span></li>
							<li><a href="#">4</a></li>
						</ul>
					</div>
					<div class="step-post-listing">
						<div class="item-step">
