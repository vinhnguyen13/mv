(function () {
	...
	var minmax = {
		...
		print: function(){
			...
			listing.imgLoaded($(strArticle).find('img'), function () {
				$('body').loading({
					done: true
				});
				$('.iframe-print').remove();
