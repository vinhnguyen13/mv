<div class="row">
    <div class="col-xs-8 col-lg-9 pdR-5">
        ...
        <!-- Bat Dong San-->
        <?= \vsoft\news\widgets\NewsWidget::widget(['view' => 'realestate'])?>

        <div class="news-tc-dn row">
            <!-- Tai Chinh -->
            <?= \vsoft\news\widgets\NewsWidget::widget(['view' => 'finance'])?>
...
<div class="box-danb">
    ...
    <div class="inbox-danb clearfix">
        ...
        <div class="pull-left item-danb">
            <div class="row">
                <div class="col-xs-4">
                    <img src="<?=Yii::$app->view->theme->baseUrl?>/resources/images/img263x176.jpg" alt="">
                </div>
                <div class="col-xs-4">
                    <img src="<?=Yii::$app->view->theme->baseUrl?>/resources/images/img263x176.jpg" alt="">
                </div>
