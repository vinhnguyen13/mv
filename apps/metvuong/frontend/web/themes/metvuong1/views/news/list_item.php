...
<div class="col-xs-6 col-sm-6 item-list">
    ...
    <p><span><em class="fa fa-calendar"></em>27/10/2015</span><a class="color-title-link" href="<?=\yii\helpers\Url::to(['news/view', 'id' => $model->id, 'slug' => $model->slug]) ?>"><?= StringHelper::truncate($model->title, 30) ?></a></p>
