...
<div class="row">
    <div class="col-sm-8 col-lg-9 col-right-home">
        <div class="news-hot">
            <div class="wrap-img bgcover" style="background-image: url(<?=Yii::$app->view->theme->baseUrl?>/resources/images/bg-banner.jpg);"></div>
        ...
        <div class="news-bds">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="wrap-img bgcover" style="background-image: url(<?=Yii::$app->view->theme->baseUrl?>/resources/images/img283x190.jpg);"></div>
                ...
                <div class="col-sm-4">
                    <div class="wrap-img bgcover" style="background-image: url(<?=Yii::$app->view->theme->baseUrl?>/resources/images/img283x190-1.jpg);"></div>
                    <p><a class="color-title-link" href="#">Nông nghiệp Việt Nam đón nhận làn sóng đầu tư chưa</a></p>
                    <p>Việt Nam có điều kiện tự nhiên thuận lợi để sản xuất nông nghiệp nhưng bao đời nay chỉ sản xuất nhỏ lẻ, manh mún nên không xây dựng được thương hiệu... </p>
                </div>
                <div class="col-sm-4">
                    <div class="wrap-img bgcover" style="background-image: url(<?=Yii::$app->view->theme->baseUrl?>/resources/images/img283x190-2.jpg);"></div>
                    <p><a class="color-title-link" href="#">Nông nghiệp Việt Nam đón nhận làn sóng đầu tư chưa</a></p>
                    <p>Việt Nam có điều kiện tự nhiên thuận lợi để sản xuất nông nghiệp nhưng bao đời nay chỉ sản xuất nhỏ lẻ, manh mún nên không xây dựng được thương hiệu... </p>
                </div>
            </div>
        </div>
        <div class="news-tc-dn row">
            <div class="col-sm-6">
                <div class="widget-title clearfix"><h2>tài chính - ngân hàng</h2></div>
                <div class="wrap-img bgcover" style="background-image: url(<?=Yii::$app->view->theme->baseUrl?>/resources/images/img458x305.jpg);"></div>
                <p><a class="color-title-link" href="#">Nông nghiệp Việt Nam đón nhận làn sóng đầu tư chưa</a></p>
                <p>Việt Nam có điều kiện tự nhiên thuận lợi để sản xuất nông nghiệp nhưng bao đời nay chỉ sản xuất nhỏ lẻ, manh mún nên không xây dựng được thương </p>
            </div>
            <div class="col-sm-6">
    ...
    <div class="col-sm-4 col-lg-3 col-left-home">
        <div class="siderbar widget-tinmoi clearfix siderbar-style">
            ...
            <ul>
                <li>
                    <div class="pull-left wrap-img bgcover" style="background-image:url(<?=Yii::$app->view->theme->baseUrl?>/resources/images/img82x55.jpg);">
                        <a href="#" title=""></a>
                    </div>
                    <div>
        ...
        <div class="siderbar widget-ads clearfix">
            <a class="wrap-img" href="#"><img src="images/img295x210.jpg" alt=""></a>
        </div>
...
<div class="box-danb">
    <h2>Dự án nổi bật</h2>
    <div class="inbox-danb clearfix">
        <div class="pull-left info-danb">
            <p><strong>Căn hộ cao cấp Dragon Hill Residence</strong></p>
            <p>Nếu ví cuộc sống như một bản tình ca thì Dragon Hill Residence and Suites 2 thực sự là một bản tình ca ... </p>
            <p><span>Chi tiết </span></p>
            <ul>
                <li>Plaschem Plaza</li>
                <li>Tòa nhà văn phòng 360 Tây Sơn</li>
                <li>Handico Tower</li>
            </ul>
        </div>
        <div class="pull-left item-danb">
            <div class="row">
                <div class="col-xs-4">
                    <div class="bgcover" style="background-image:url(<?=Yii::$app->view->theme->baseUrl?>/resources/images/img263x176.jpg);"></div>
                </div>
                <div class="col-xs-4">
                    <div class="bgcover" style="background-image:url(<?=Yii::$app->view->theme->baseUrl?>/resources/images/img263x176.jpg);"></div>
                </div>
