                        ...
                        <div class="pull-left">
                            ...
                            <div class="pull-left text-right mgT-10">
                                <div data-active="1" data-tab="mua-thue" class="search-select active" data-step='step1'>
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="<?= htmlentities("Tìm kiếm bất động sản cần <span>Mua</span> hoặc <span>Thuê</span>") ?>">
                                        <span>
                                ...
                                <div data-active="2" data-tab="ban-thue" class="search-select" data-step='step2'>
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="<?= htmlentities("Rao tin bất động sản cần <span>Bán</span> hoặc <span>Cho Thuê</span>") ?>">
                                        <span>
                                            <em class="fa fa-home"></em>
                                ...
                                <div data-active="3" data-tab="tin-tuc"  class="search-select" data-step='step3'>
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="<?= htmlentities("<span>Tin tức</span> và <span>dự án</span> bất động sản") ?>">
                                        <span>
                                            <em class="fa fa-home"></em>
