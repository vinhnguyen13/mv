<div class="container">
	<div class="wrap-content-page">
		...
		<p class="text-uper color-cd fs-15 font-600">SẮP RA MẮT 3 Tính năng nổi bật:</p>
		<p>Nhằm giúp so sánh các tin đăng mà bạn đang muốn tìm hiểu thêm và tìm ra được sản phẩm ưng ý nhất, MetVuong.com mang đến các tính năng hữu ích cho phép bạn so sánh về vị trí, giá cả và nhiều nhiều hơn nữa.</p>
