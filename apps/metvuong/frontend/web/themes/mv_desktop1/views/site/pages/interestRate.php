...
Yii::$app->getView()->registerJsFile('http://antt.vn/js/tools.js?v18', ['position' => \yii\web\View::POS_BEGIN]);
?>
<script type="text/javascript">var base_url = '<?=\yii\helpers\Url::home()?>';</script>

<div class="title-fixed-wrap">
    <div class="chat-history">
        <main class="news_blocks_contain" style="min-height: 26px;">
            <header class="tool-hdr"> Tính lãi suất vay vốn </header>
            <article>
                <div class="sum"> Cho phép bạn tính toán tiền tiết kiệm khi gửi một số tiền theo một kỳ hạn nhất định và so sánh lãi suất, tiền được hưởng giữa các ngân hàng </div>                        <table class="funding-tbl">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="soTienVay" name="soTienVay" value="" style="width:15em;">
                            VND
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="laiSuat" name="laiSuat" value="" style="width:15em;">
                            <select id="theoThoiGian" name="theoThoiGian" style="width: 9.5em;">
                    ...
                    <tr>
                        ...
                        <td> <input type="text" name="thoiGianVay" id="thoiGianVay" value="" style="width:15em;"> Tháng </td>
                    </tr>
                    <tr>
                        <td> </td>
                        <td> <a onclick="Tools.loan_calculate();" class="btn-form"> Tính nhanh <span class="arrow-icon"> </span> </a> </td>
                    </tr>
                    </tbody>
                </table>
            </article>

            <header class="tool-hdr black-hdr"> Kết quả </header>
            <article>
