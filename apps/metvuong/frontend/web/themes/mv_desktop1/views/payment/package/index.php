...
<div class="type-payment">
	<div class="container">
	    ...
	    <p class="color-red mgB-10"><span class="font-700 d-ib mgR-10">Lưu ý:</span>1 GOLD = 1.000 VNĐ</p>
	    ...
	    <div id="the-cao" class="item-payment active">
	        ...
	        <div class="w-40 pd-20">
	            ...
	            <div class="text-left">
	                <button class="btn-common">Nạp Gold</button>
	            </div>
	        </div>
	    </div>
	    ...
	    <div id="credit-card" class="item-payment">
	        ...
	        <div class="pdT-20 pdB-40 pdL-50 pdR-50">
	            <div class="method_napcard_inner">
	                ...
	                <div class="row">
	                    <div class="col-md-4 col-sm-6 col-xs-12">
	                        <div class="vip_wrapper vip-9722">
	                            <h3 class="vip_title">Package - 1500 Gold</h3>
	                            <div class="vip_content">
	                            Giá 1.000.000 VNĐ                                               </div>
	                            <div class="vip_button">
	                                <a type="button" class="btn-common" href="#">Nạp Gold</a>
	                            </div>
	                        </div>
	                    </div>
	                    <div class="col-md-4 col-sm-6 col-xs-12">
	                        <div class="vip_wrapper vip-9721">
	                            <h3 class="vip_title">Package - 600 Gold</h3>
	                            <div class="vip_content">
	                            Giá 500.000 VNĐ                                             </div>
	                            <div class="vip_button">
	                                <a type="button" class="btn-common" href="#">Nạp Gold</a>
	                    ...
	                    <div class="col-md-4 col-sm-6 col-xs-12">
	                        <div class="vip_wrapper vip-9720">
	                            <h3 class="vip_title">Package -  250 Gold</h3>
	                            <div class="vip_content">
	                            Giá 200.000 VNĐ                                             </div>
	                            <div class="vip_button">
	                                <a type="button" class="btn-common" href="#">Nạp Gold</a>
	                    ...
	                    <div class="col-md-4 col-sm-6 col-xs-12">
	                        <div class="vip_wrapper vip-9719">
	                            <h3 class="vip_title">Package - 120 Gold</h3>
	                            <div class="vip_content">
	                            Giá 100.000 VNĐ                                             </div>
	                            <div class="vip_button">
	                                <a type="button" class="btn-common" href="#">Nạp Gold</a>
	                    ...
	                    <div class="col-md-4 col-sm-6 col-xs-12">
	                        <div class="vip_wrapper vip-9718">
	                            <h3 class="vip_title">Package - 55 Gold</h3>
	                            <div class="vip_content">
	                            Giá 50.000 VNĐ                                              </div>
	                            <div class="vip_button">
	                                <a type="button" class="btn-common" href="#">Nạp Gold</a>
	                    ...
	                    <div class="col-md-4 col-sm-6 col-xs-12">
	                        <div class="vip_wrapper vip-9717">
	                            <h3 class="vip_title">Package - 10 Gold</h3>
	                            <div class="vip_content">
	                            Giá 10.000 VNĐ                                              </div>
	                            <div class="vip_button">
	                                <a type="button" class="btn-common" href="#">Nạp Gold</a>
	                ...
	                <p style="font-size: 20px; color: #fff; background: red; display: block; padding: 5px 10px;"><span>Lưu ý:</span> Bạn phải CHỜ 10 GIÂY để nhận kết quả xử lý từ Ngân Lượng. TUYỆT ĐỐI KHÔNG ĐÓNG TRÌNH DUYỆT. Khi giao dịch được xác định thành công, bạn sẽ được tự động chuyển về web metvuong, lúc đó chúng tôi sẽ trả Gold cho bạn. </p>
	                <br>
