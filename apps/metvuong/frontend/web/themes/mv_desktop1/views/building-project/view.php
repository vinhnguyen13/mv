                                    ...
                                    <div class="a1">
                                        <div class="item chudautu-infor thong-tin-khac">
                                            <div class="info-detail">
                                                ...
                                                <?= !empty($model->land_area) ? "<div><span>". Yii::t('project', 'Land Area'). ":</span> ". rtrim(number_format($model->land_area, 2), ".00"). "</p></div>" : null?>
                                                ...
                                                <?= !empty($model->gfa) ? "<div><span>". Yii::t('project','GFA'). ":</span><p>". rtrim(number_format($model->gfa, 2), ".00"). "</div>" : null?>
