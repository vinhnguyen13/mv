    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="bottom-popup">
                <p class="push-price fs-13 text-right font-600"><span class="d-ib lh-100"><?=Yii::t('chart', 'Để tin đạt hiệu quả hơn vui lòng click vào đây')?></span> 
                    <a href="#" data-toggle="modal" data-target="#update-boost" data-product="<?=$id?>" class="btn-nang-cap mgL-10 btn-boost btn-bd-radius btn-small btn"><?= Yii::t('statistic', 'Up') ?></a>
                </p>
            </div>
        </div>
    </div>
