...
<div class="notify">
	...
	<div class="text-center">
		<a class="btn-common mgR-10" href="<?= Url::to(['/ad/boost', 'day' => 3, 'id' => $product->id]) ?>"><?= sprintf(Yii::t("ad", "Boost %s ngày"), "3") ?></a>
		<a class="btn-common mgR-10" href="<?= Url::to(['/ad/boost', 'day' => 1, 'id' => $product->id]) ?>"><?= sprintf(Yii::t("ad", "Boost %s ngày"), "1") ?></a>
	</div>
</div>
