...
use vsoft\express\components\StringHelper;
	...
	$resourceListingMap = Yii::$app->view->theme->baseUrl . '/resources/js/map' . $compress . '.js?v=4';
...
EOD;
	...
	$this->registerJsFile(Yii::$app->view->theme->baseUrl . '/resources/js/listing' . $compress . '.js?v=4', ['position' => View::POS_END]);
