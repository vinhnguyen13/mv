...
EOD;
	...
	$this->registerCss('.info-arrow {position: absolute; left: 50%; width: 0px; height: 0px; margin-left: -6px;} .bottom .info-arrow {border-left: 6px solid transparent; border-right: 6px solid transparent; border-bottom: 8px solid #fff; top: -6px;} .top .info-arrow {bottom: -6px; border-left: 6px solid transparent; border-right: 6px solid transparent; border-top: 8px solid #fff;} .top .info-wrap-single {margin-bottom: 8px;} .bottom .info-wrap-single {margin-top: 8px;} .infor-duan-suggest .img-intro {margin-bottom: -6px;} #map-wrap {position: relative;} #progress-bar {transition: width 0.1s; display: none; top:0; position: absolute; width: 0%; height: 2px; background: #00a769;} #search-list .center {text-align: center; margin: 10px 0; opacity: 0.6;} #search-list .hint {padding: 8px 20px; display: block; background: #00a769; color: #FFF;} .gm-style-mtc {opacity: 0.8;} .gm-style-mtc:hover {opacity: 1;} .gm-style {font-family: "open-sans", monospace} .dt-pagination { display: block; margin-top: 12px; margin-bottom: 6px; } #map-search-wrap {position: relative; width: 220px;} #map-search {height: 40px; line-height: 40px; font-size: 14px; padding: 0 8px 0 8px; width: 100%;} #search-list {position: absolute; background: #FFF; box-shadow: 1px 2px 2px rgba(0, 0, 0, 0.3); font-size: 15px; white-space: nowrap; z-index: 1;} #search-list a {display: block; padding: 6px 12px; border-top: 1px solid rgba(0, 0, 0, 0.1);} #search-list .active a {background: #F5F5F5;} @media (max-width: 985px) {#map-search-wrap {width: 100%;} #search-list{ width: 100%; white-space: initial;}}');
									...
									<div class="box-dropdown" data-item-minmax="prices">
										...
										<div class="item-dropdown hide-dropdown wrap-min-max">
											<div class="box-input clearfix">
												<span class="txt-min min-max active min-val" data-value="0" data-text="<?= Yii::t('ad', 'Min') ?>"><?= Yii::t('ad', 'Min') ?></span>
												<span class="text-center"><span></span></span>
												<span class="txt-max min-max max-val" data-value="0" data-text="<?= Yii::t('ad', 'Max') ?>"><?= Yii::t('ad', 'Max') ?></span>
