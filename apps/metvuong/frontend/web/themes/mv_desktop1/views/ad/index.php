...
use vsoft\ad\models\TrackingSearch;
	...
	$resourceListingMap = Yii::$app->view->theme->baseUrl . '/resources/js/map' . $compress . '.js?v=2';
...
EOD;
	...
	$this->registerJsFile(Yii::$app->view->theme->baseUrl . '/resources/js/listing' . $compress . '.js?v=2', ['position' => View::POS_END]);
