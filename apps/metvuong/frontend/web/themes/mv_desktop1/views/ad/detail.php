    	...
    	<div id="detail-wrap" class="col-xs-12 col-md-9 col-left">
			...
			<div class="infor-listing">
				<div class="address-feat clearfix">
					<p class="date-post pull-right fs-13"><?= Yii::t('ad', 'đăng') ?> <?= StringHelper::previousTime($product->start_date) ?><span class="pull-right mgL-20"><?= Yii::t('ad', 'Điểm') ?>: <?php $score = round($product->score - 0.00001157407 * (time() - $product->start_date)); if($score > 0) echo $score; else echo 0; ?></span></p>
					<p class="infor-by-up">
