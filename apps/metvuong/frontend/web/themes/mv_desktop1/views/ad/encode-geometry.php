...
use yii\helpers\Url;
	...
	$this->registerJsFile(Yii::$app->view->theme->baseUrl . '/resources/js/encode.js', ['position' => View::POS_END]);
	$this->registerJs('var url = "' . Url::to(['/ad/encode-geometry']) . '";', View::POS_BEGIN);
