//(function(){
    var chatUI = {
        ...
        loadMessageToList: function (msg, params) {
            ...
            var template = Handlebars.compile($(".chat-receive-template").html());
            var html = template({msg: msg, avatarUrl: '/member/'+chatUI.usrFromJid(this.from)+'/avatar', time: _time, fromName: params.fromName, chatUrl: chat_url + '?username=' +chatUI.usrFromJid(this.from), from: chatUI.usrFromJid(this.from)});
