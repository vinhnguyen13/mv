...
class m151215_030947_profile extends Migration
{
    public function up()
    {
        $this->execute("ALTER TABLE `profile` ADD COLUMN `phone` VARCHAR(20) DEFAULT NULL  AFTER `avatar`;");
        $this->execute("ALTER TABLE `profile` ADD COLUMN `mobile` VARCHAR(30) DEFAULT NULL  AFTER `phone`;");
