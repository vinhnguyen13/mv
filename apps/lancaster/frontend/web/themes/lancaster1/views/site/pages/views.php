...
$slideHome = LcHomeGallery::find()->where(['code'=>'VIEWS'])->one();
...
if(!empty($photos)){
    foreach($photos as $key=>$photo):
        ...
        $indicator .= $this->render('_indicator', ['key'=>$key, 'photo'=>$photo, 'target'=>'views']);
    endforeach;
}
?>
<div class="container-fluid layoutapartments">
    <div id="views" class="carousel slide" data-ride="carousel">
        <!-- Indicators -->
