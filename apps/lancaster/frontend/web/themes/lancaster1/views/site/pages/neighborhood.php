...
if(!empty($photos)){
    foreach($photos as $key=>$photo):
        ...
        $indicator .= $this->render('_indicator', ['key'=>$key, 'photo'=>$photo, 'target'=>'neighborhood']);
    endforeach;
}
?>
<div class="container-fluid layoutapartments">
    <div id="neighborhood" class="carousel slide" data-ride="carousel">
        <!-- Indicators -->
        ...
        <a class="left carousel-control" href="#neighborhood" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="right carousel-control" href="#neighborhood" role="button" data-slide="next">
