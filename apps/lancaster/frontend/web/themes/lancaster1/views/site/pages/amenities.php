...
if(!empty($photos)){
    foreach($photos as $key=>$photo):
        ...
        $indicator .= $this->render('_indicator', ['key'=>$key, 'photo'=>$photo, 'target'=>'amenities']);
    endforeach;
}
?>
<div class="container-fluid layoutapartments">
    <div id="amenities" class="carousel slide" data-ride="carousel">
        <!-- Indicators -->
        ...
        <a class="left carousel-control" href="#amenities" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="right carousel-control" href="#amenities" role="button" data-slide="next">
